...
var projects = [
	{
		...
		"desc": "An event finding app where users search for events by city with the Yelp API. Users can authenticate with Google to sign up for events and see other users who are going. Users can select events and most efficient route for walking or driving via the Google Directions API. HTML/CSS, Bootstrap, Javascript, AngularJS, Node.js, Express, MongoDB, Mongoose, OAuth."
	},
	{
		"title": "Gold Medals",
		"link": "https://olympic-medals.herokuapp.com/",		
		"pic": "../images/olympics.png",
		"desc": "Olympic medal tracker that stores gold medal winners by event. Users can break down the winners by country and event to see graphical results as the games develop. HTML/CSS, Javascript-ES6, d3.js, AngularJS, Node.js, Express, MongoDB, Mongoose, Redis."
	},
	{
		"title": "Easy Polls",
		"link": "https://voting-polling-app.herokuapp.com/",		
		"pic": "../images/votingapp.png",
		"desc": "A polling app that allows authenticated users to create, vote, and share polls on any topic. Each poll can be voted on once and results can be viewed in graph format. Users can also randomly generate polls on a topic of choice. HTML/CSS, Bootstrap, Javascript, AngularJS, Node.js, Express, MongoDB. "
	},
	{
		...
		"desc": "A research project and tutorial built with d3.js tracks how Leicester City FC won the 2015-2016 Premier League. Interactive graphs show the relationship between goals, points, and goal differential over the course of the season. HTML/CSS, Javascript, d3.js"
	},
	{
		"title": "A Multi-Talented Slack Bot",
		"link": "https://www.joemcilhargey.com/articles/building-a-talented-slack-bot-in-node/",
		"pic": "../images/slack-bot.png",
		"desc": "A Slack bot assistant that can fetch current news and stock prices, calculate distances and estimated travel times, get the local forecast, and call an Uber to pick you up. Node.js, WebSockets, HTTP/HTTPS, Google, Quandl, OpenWeather, and Uber APIs"
	},
	{
		"title": "Image Search Tool",
		"link": "https://image-search-tool.herokuapp.com/",		
		"pic": "../images/imagesearchtool.png",
		"desc": "A microservice API that allows users to access the Google Image Search API by keyword and view top images. Results are paginated and search history stored in DB. HTML/CSS, Bootstrap, Javascript, Node.JS, Express, MongoDB."
	},
	{
		"title": "URL Shortener",
		"link": "https://url-service.herokuapp.com/",		
		"pic": "../images/urlshortener.png",
		"desc": "A microservice API that shortens URLs via random character generation and stores route and original address in DB. HTML/CSS, Bootstrap, Javascript, Node.JS, Express, MongoDB."
	},
	{
		"title": "Simon",
	...
	},
	{
		...
		"desc": "A microservice API that checks upload file size and returns JSON results. HTML/CSS, Bootstrap, Javascript, Node.JS, Express, MongoDB."
	},
	{
		"title": "Convert Time Stamp",
		"link": "https://timestamp-service-api.herokuapp.com/",		
		"pic": "../images/timestampservice.png",
		"desc": "A microservice API that accepts date in standard or UNIX format and returns JSON with both. HTML/CSS, Bootstrap, Javascript, Node.JS, Express, MongoDB."
	},	
	{
		"title": "Request Header",
		"link": "https://header-parser-microservice.herokuapp.com/",		
		"pic": "../images/requestheaderservice.png",
		"desc": "A microservice API that returns JSON with client header information. HTML/CSS, Bootstrap, Javascript, Node.JS, Express, MongoDB."
	},	
	{
		"title": "Stories",
